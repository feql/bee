...
function create_new_project(){
    ...
    //configure nginx
    $nginx_sites_available_dir = "/sites_enabled/"; //getenv("FEQL_NGINX_SITES_AVAILABLE_DIR");
    ...
    if(!file_exists($app_nginx_config_file)){
        ...
        $nginx_sites_enabled_dir = "/sites_available/"; //getenv("FEQL_NGINX_SITES_AVAILABLE_DIR");
    ...
    $BEE_BR_HONEY[BEE_RI] = [$app_sub_domain]; //[$app_sub_domain, $subdomain_res, $www_subdomain_res];
}
